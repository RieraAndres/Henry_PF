        ...
        <div className={styles.Container}>
            ...
            <div className={styles.body}>
                ...
                <div className={styles.presentar}>
                    ...
                    <p>Es simple pero poderosa, brindar una segunda oportinidad a las mascotas abandonadas, maltratadas, o simplemente que no puedan seguir en su hogar,
                ...
                <div className={styles.trabajo}>
                    ...
                    <p><b>ADOPCIÓN RESPONSABLE:</b> Se realiza un proseso de adopción para asegurar de que cada una sea adoptada por la familia adecuada.</p>
